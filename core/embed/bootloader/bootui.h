...
void ui_screen_firmware_info(const vendor_header* const vhdr, const image_header* const hdr);
...
void ui_screen_confirm(char* title, char* note_l1, char* note_l2, char* note_l3, char* note_l4);
...
void ui_install_confirm(image_header* current_hdr, const image_header* const new_hdr);
...
void ui_install_progress(image_header* current_hdr, const image_header* const new_hdr);
